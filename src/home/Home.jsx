...
export const Home = () => (
  <div className='container'>
    <div id='leftSideOfPage'></div>
    <div id='rightSideOfPage'></div>
    <div className='contentContainer'>
      ...
      <div className='philosophyBox'>
        ...
        <Link to='/Lectures' className='fourcatBox'>
          <div className='fourcatText'>Lectures</div>
        ...
        <Link to='/Papers' className='fourcatBox'>
          <h1 className='fourcatText'>Papers</h1>
        ...
        <Link to='/Projects' className='fourcatBox'>
          <h1 className='fourcatText'>Projects</h1>
        ...
        <Link to='/Courses' className='fourcatBox'>
          <h1 className='fourcatText'>Courses</h1>
